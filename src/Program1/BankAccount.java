 ...
 * This class manages account information including ID, balance, and interest
 * rate.
 */
public class BankAccount {
  ...
  /**
   * Constructs a new BankAccount with specified account ID, initial balance, and
   * interest rate.
   *
   ...
   * @throws IllegalArgumentException if amount is negative or exceeds current
   *                                  balance
   */
